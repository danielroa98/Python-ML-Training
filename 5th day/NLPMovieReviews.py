...
# This version doesn't subtract any more words from the set
...
# Scrolls across all of the values
for i in range(0, len(dataset)):
    # cleaned reviews in variable review, this step will only keep the letters from A-z in the review and  remove  the numbers, puntuation part, exclanmations,question marks
    ...
    #stemming is keepig only the parent word love is root of loveable,loved,lovely
