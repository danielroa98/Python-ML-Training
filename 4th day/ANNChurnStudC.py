...
classifier.add(Dense(input_dim=11, units=_____,kernel_initializer='uniform',activation='relu'))

## Add 2nd Hidden Layer with 6 Neurons

classifier.add(Dense(units=_____,kernel_initializer='uniform',activation='relu'))
...
classifier.get_layer('______').get_weights()
...
# =============================================================================
history=classifier.fit(X_train,y_train, batch_size=____,epochs=100)
